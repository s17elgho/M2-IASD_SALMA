...
print('*****************************')
print('demo buddha dataset')
print('*****************************')

print('point clouds in their original reference frame ...')
print('... press \'q\' to continue ...')

pcd1 = o3d.io.read_point_cloud('happySideRight_0.ply')
pcd2 = o3d.io.read_point_cloud('happySideRight_24.ply')
...
o3d.io.write_point_cloud("budda1a.ply", pcd1a)
o3d.io.write_point_cloud("budda2a.ply",pcd2a )