...
print('*****************************')
print('demo 3D match dataset')
print('*****************************')

print('point clouds in their original reference frame ...')
print('... press \'q\' to continue ...')

pcd1 = o3d.io.read_point_cloud('cloud_bin_0.ply')
pcd2 = o3d.io.read_point_cloud('cloud_bin_1.ply')
...
o3d.io.write_point_cloud("cloud1a.ply", pcd1a)
o3d.io.write_point_cloud("cloud2a.ply",pcd2a )