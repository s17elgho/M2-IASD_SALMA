...
print('*****************************')
print('demo Notre_dame dataset')
print('*****************************')

print('point clouds in their original reference frame ...')
print('... press \'q\' to continue ...')

pcd1 = o3d.io.read_point_cloud('Notre_Dame_Des_Champs_2.ply')
pcd2 = o3d.io.read_point_cloud('Notre_Dame_Des_Champs_1.ply')
...
o3d.io.write_point_cloud("notre_dame1a.ply", pcd1a)
o3d.io.write_point_cloud("notre_dame2a.ply",pcd2a )