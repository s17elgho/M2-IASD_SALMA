...
print('*****************************')
print('demo bunny dataset')
print('*****************************')

print('point clouds in their original reference frame ...')
print('... press \'q\' to continue ...')

pcd1 = o3d.io.read_point_cloud('bunny_perturbed.ply')
pcd2 = o3d.io.read_point_cloud('bunny_original.ply')
...
o3d.io.write_point_cloud("bunny1a.ply", pcd1a)
o3d.io.write_point_cloud("bunny2a.ply",pcd2a )