...
pcd1 = mesh.sample_points_uniformly(number_of_points=30000)

your_transform = np.asarray([[ 0.99276509, 0.12002144,-0.00351277,-0.00893615],[-0.11663863, 0.97090498, 0.2091386,   0.00157403],[ 0.02851168 ,-0.20721577 , 0.9778797,   0.02001847],[ 0.     ,     0.    ,      0.    ,      1.        ]])
pcd2  = copy.deepcopy(pcd1).transform(your_transform)
...
o3d.io.write_point_cloud("cylindre1.ply",pcd1 )
o3d.io.write_point_cloud("cylindre2.ply",pcd2)
...
print('... press \'q\' to continue ...')
o3d.io.write_point_cloud("cylindre1a.ply",pcd1a )
o3d.io.write_point_cloud("cylindre2a.ply",pcd2a)
